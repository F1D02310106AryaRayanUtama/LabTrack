"""
controllers.py - Controller layer v2.0
Hak akses:
  admin   → semua fitur + kelola user + approve/reject request
  laboran → CRUD inventaris, peminjam, peminjaman, approve/reject request
  viewer  → lihat katalog barang, ajukan peminjaman/pengembalian, lihat riwayat sendiri
"""
